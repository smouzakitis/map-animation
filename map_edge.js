...
"stage": {
    ...
    content: {
            dom: [
            {
                id: 'GreekMap_Map_Only5',
                type: 'image',
                rect: ['5px', '8px','540px','684px','auto', 'auto'],
                opacity: 0.63414633274078,
                fill: ["rgba(0,0,0,0)",im+"GreekMap_Map_Only.png",'0px','0px']
            },
            {
                id: 'Lines_Flashing',
                type: 'rect',
                rect: ['142', '76','auto','auto','auto', 'auto']
            },
            {
                id: 'Larimna',
                type: 'rect',
                rect: ['-35px', '-45px','auto','auto','auto', 'auto']
            },
            {
                id: 'Thesaloniki',
                type: 'rect',
                rect: ['-72px', '-264px','auto','auto','auto', 'auto']
            },
            {
                id: 'Amyntaio',
                type: 'rect',
                rect: ['-156px', '-249px','auto','auto','auto', 'auto']
            },
            {
                id: 'Meliti',
                type: 'rect',
                rect: ['-156px', '-264px','auto','auto','auto', 'auto']
            },
            {
                id: 'Lagkadas',
                type: 'rect',
                rect: ['-42px', '-287px','auto','auto','auto', 'auto']
            },
            {
                id: 'AgDimitrios',
                type: 'rect',
                rect: ['-131px', '-227px','auto','auto','auto', 'auto']
            },
            {
                id: 'Kardia',
                type: 'rect',
                rect: ['-147px', '-227px','auto','auto','auto', 'auto']
            },
            {
                id: 'Filippoi',
                type: 'rect',
                rect: ['49px', '-295px','auto','auto','auto', 'auto']
            },
            {
                id: 'NeoSanta',
                type: 'rect',
                rect: ['187px', '-304px','auto','auto','auto', 'auto']
            },
            {
                id: 'Aliveri',
                type: 'rect',
                rect: ['37px', '-35px','auto','auto','auto', 'auto']
            },
            {
                id: 'Distomo',
                type: 'rect',
                rect: ['-71px', '-35px','auto','auto','auto', 'auto']
            },
            {
                id: 'Agios_Stefanos',
                type: 'rect',
                rect: ['20px', '-6px','auto','auto','auto', 'auto']
            },
            {
                id: 'Acharnes',
                type: 'rect',
            ...
            },
            {
                id: 'Trikala',
                type: 'rect',
                rect: ['-140px', '-143px','auto','auto','auto', 'auto']
            },
            {
                id: 'Larisa',
                type: 'rect',
                rect: ['-93px', '-151px','auto','auto','auto', 'auto']
            },
            {
                id: 'Axeloos',
                type: 'rect',
                rect: ['-170px', '-61px','auto','auto','auto', 'auto']
            },
            {
                id: 'Pallini',
                type: 'rect',
                rect: ['20px', '8px','auto','auto','auto', 'auto']
            },
            {
                id: 'Argyroupoli',
                type: 'rect',
            ...
            },
            {
                id: 'Laurio',
                type: 'rect',
                rect: ['34px', '23px','auto','auto','auto', 'auto']
            },
            {
                id: 'Korinthos',
                type: 'rect',
                rect: ['-72px', '30px','auto','auto','auto', 'auto']
            },
            {
                id: 'Megalopoli',
                type: 'rect',
                rect: ['-110px', '67px','auto','auto','auto', 'auto']
            }],
            symbolInstances: [
            {
                id: 'Kardia',
    ...
    states: {
        "Base State": {
            ...
            "${_GreekMap_Map_Only5}": [
                ["style", "top", '8px'],
                ["style", "opacity", '0.63414634146341'],
                ["style", "left", '5px']
            ],
            "${_Aliveri}": [
                ["style", "left", '37px'],
...
"City": {
    ...
    content: {
            dom: [
                {
                    transform: [[], [], [], ['1.2', '1.2']],
                    rect: ['326px', '275px', '25px', '26px', 'auto', 'auto'],
                    borderRadius: ['50%', '50%', '50%', '50%'],
                    type: 'ellipse',
                    id: 'InfoBubbleBack',
                    stroke: [5, 'rgba(251,0,0,1.00)', 'solid'],
                    display: 'none',
                    fill: ['rgba(233,8,29,1.00)']
                },
                {
                    transform: [[], [], [], ['0', '0']],
                    rect: ['326px', '275px', '25px', '26px', 'auto', 'auto'],
                    ...
                    display: 'none',
                    fill: ['rgba(188,59,58,1)']
                },
                {
                    rect: ['322px', '295px', '83px', '44px', 'auto', 'auto'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid64", tween: [ "transform", "${_cityPoint}", "scaleY", '2', { fromValue: '0'}], position: 0, duration: 370, easing: "easeOutQuad" },
                { id: "eid65", tween: [ "transform", "${_cityPoint}", "scaleY", '1', { fromValue: '2'}], position: 370, duration: 130, easing: "easeOutCubic" },
                { id: "eid405", tween: [ "transform", "${_cityPoint}", "scaleY", '2', { fromValue: '1'}], position: 1000, duration: 155, easing: "easeOutQuad" },
                { id: "eid410", tween: [ "transform", "${_cityPoint}", "scaleY", '1', { fromValue: '2'}], position: 1500, duration: 160, easing: "easeOutQuad" },
                ...
                { id: "eid62", tween: [ "transform", "${_cityPoint}", "scaleX", '2', { fromValue: '0'}], position: 0, duration: 370, easing: "easeOutCubic" },
                { id: "eid63", tween: [ "transform", "${_cityPoint}", "scaleX", '1', { fromValue: '2'}], position: 370, duration: 130, easing: "easeOutCubic" },
                { id: "eid404", tween: [ "transform", "${_cityPoint}", "scaleX", '2', { fromValue: '1'}], position: 1000, duration: 155, easing: "easeOutQuad" },
                { id: "eid409", tween: [ "transform", "${_cityPoint}", "scaleX", '1', { fromValue: '2'}], position: 1500, duration: 160, easing: "easeOutQuad" },
...
"Lines_Flashing": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid249", tween: [ "style", "${_lines}", "opacity", '1', { fromValue: '0.23'}], position: 0, duration: 1500, easing: "easeOutQuad" },
                { id: "eid250", tween: [ "style", "${_lines}", "opacity", '0.22764227642276', { fromValue: '1'}], position: 1500, duration: 1500, easing: "easeOutQuad" }            ]
        }
    }
}
};
